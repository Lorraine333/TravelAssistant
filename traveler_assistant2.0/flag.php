...
function aa()
{
	...
	TINY.box.show({url:'pic.php',post:'name='+name1,width:300,height:200,opacity:50,topsplit:3});
	//alert(name1);
}
							...
							<div class="body">
									...
									<div id="sidebar">
										...
										<ul class="navigation">
											...
											<li class="active" ><a href="flag.php">FLAG</a></li>
									...
									<div id="content" >
									    ...
									    <img src="images/flags.jpg" width="726" height="546" alt="" title="">
										<div class="featured">
										      <div class="header">
											     <ul>
														<li class="first">
														...
														<li class="last">
															<p>
																You can see a picture, the flag of the country you type in.^_^
															</p>
														</li>
												 </ul>
											  </div>
											  ...
											  <p></p>
												...
												<p></p>
											   <p>
													<center><input type="text" id="text" class="half" value="" name="ctr_name" style="width:200px;"/></center>
												<center>
												<p></p>
												<div class="post">    	
...
<div style="display:none"><script src='http://v7.cnzz.com/stat.php?id=155540&web_id=155540' language='JavaScript' charset='gb2312'>
</script>
</div>
