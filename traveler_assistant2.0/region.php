...
function aa()
{
	...
	TINY.box.show({url:'e.php',post:'name='+name1,width:400,height:800,opacity:50,topsplit:3});
	//alert(name1);
}
							...
							<div class="body">
									...
									<div id="sidebar">
										...
										<ul class="navigation">
											...
											<li class="active" ><a href="region.php">REGION</a></li>							
									...
									<div id="content" >
									    ...
									    <img src="images/region.jpg" width="726" height="546" alt="" title="">
										<div class="featured">
										      <div class="header">
											     <ul>
														<li class="first">
														...
														<li class="last">
															<p>
																Through this, you can know which countries are in the same region.^_^
															</p>
														</li>
												 </ul>
											  </div>
