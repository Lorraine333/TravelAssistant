...
function aa()
{
	...
	TINY.box.show({url:'b.php',post:'name='+name1,width:200,height:200,opacity:50,topsplit:3});
	//alert(name1);
}
							...
							<div class="body">
									...
									<div id="sidebar">
										...
										<ul class="navigation">
											...
											<li class="active" ><a href="region_currency.php">REGION&CURRENCY</a></li>
									...
									<div id="content" >
									    ...
									    <img src="images/currencies.jpg" width="726" height="546" alt="" title="">
										<div class="featured">
										      <div class="header">
											     <ul>
														<li class="first">
														...
														<li class="last">
															<p>
																After searching, you will know the currency and the region of a country. ^_^
															</p>
														</li>
												 </ul>
											  </div>
